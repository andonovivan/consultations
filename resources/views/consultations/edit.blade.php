            ...
            <form method="post" action="{{ route('consultations.update', $consultation->id) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select
                            ...
                            @foreach($professors as $professor)
                                @if($professor->id === $consultation->professor_id)
                                    <option
                                        selected
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select
                            ...
                            @foreach($rooms as $room)
                                @if($room->id === $consultation->room_id)
                                    <option
                                        selected
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="datetime-local" class="form-control" id="time_from"
                               value="{{\Carbon\Carbon::parse($consultation->time_from)->format('Y-m-d\TH:i')}}"
                               name="time_from"/>
                    </div>

                    <div class="form-group col-md-6">
                        <label for="time_to">To</label>
                        <input type="datetime-local" class="form-control" id="time_to"
                               value="{{\Carbon\Carbon::parse($consultation->time_to)->format('Y-m-d\TH:i')}}"
                               name="time_to"/>
                    </div>
                </div>
